  ...
  return (
    <div id={style.main}>
      ...
      <div id={style.box}>
        ...
        <details>
          <summary>
            What is Netflix ? <AiOutlineClose id={style.icon} />
          </summary>
          <p>
        ...
        <details>
          <summary>
            How much does Netflix cost? <AiOutlineClose id={style.icon} />
          </summary>
          <p>
        ...
        <details>
          <summary>
            Where can I watch? <AiOutlineClose id={style.icon} />
          </summary>
          <p>
        ...
        <details>
          <summary>
            How do I cancel? <AiOutlineClose id={style.icon} />
          </summary>
          <p>
        ...
        <details>
          <summary>
            What can I watch on Netflex? <AiOutlineClose id={style.icon} />
          </summary>
          <p>
        ...
        <details>
          <summary>
            Is Netflix good for kids? <AiOutlineClose id={style.icon} />
          </summary>
          <p>
